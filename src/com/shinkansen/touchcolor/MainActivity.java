...
public class MainActivity extends Activity {
	...
	private String getBestMatchingColorName(int pixelColor) {
		...
		mColors.put("green", Color.rgb(0, 37, 0));
		mColors.put("green", Color.rgb(0, 64, 0));
		mColors.put("green", Color.rgb(0, 80, 0));
		mColors.put("green", Color.rgb(0, 117, 0));
		mColors.put("green", Color.rgb(0, 166, 0));
		mColors.put("green", Color.rgb(0, 187, 0));
		mColors.put("green", Color.rgb(0, 219, 0));
		mColors.put("green", Color.rgb(0, 236, 0));
		mColors.put("green", Color.rgb(40, 255, 40));
		...
		mColors.put("red", Color.rgb(234, 0, 0));
		mColors.put("red", Color.rgb(255, 0, 0));
		mColors.put("red", Color.rgb(255, 45, 45));
		...
		mColors.put("orange", Color.rgb(234, 117, 0));
		...
		mColors.put("purple", Color.rgb(91, 0, 174));
		mColors.put("purple", Color.rgb(111, 0, 211));
		mColors.put("purple", Color.rgb(134, 0, 255));
		mColors.put("purple", Color.rgb(146, 26, 255));
		mColors.put("purple", Color.rgb(159, 53, 255));

		mColors.put("pink", Color.rgb(147, 0, 147));
		mColors.put("pink", Color.rgb(174, 0, 174));
		mColors.put("pink", Color.rgb(210, 0, 210));
		mColors.put("pink", Color.rgb(232, 0, 232));
		mColors.put("pink", Color.rgb(255, 0, 255));
		mColors.put("pink", Color.rgb(255, 68, 255));
		mColors.put("pink", Color.rgb(255, 119, 255));
